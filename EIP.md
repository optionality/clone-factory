...
This standard supports use-cases wherein it is desireable to clone exact contract functionality with a minimum of side effects (e.g. memory slot stomping) and with inexpensive deployment of proxy instances.  It allows users and tools to rely on the behavior of the proxies over time.
